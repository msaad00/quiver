...
SKILL_ROOT_EXCEPTIONS: dict[str, set[str]] = {
    ...
    "detection-engineering": {
        # Doc-only category alias. Only `golden/` and `captured/` carry
        # real content (synthetic and provenance-tracked fixtures
        # respectively); the other historic per-skill subdirs disappeared
