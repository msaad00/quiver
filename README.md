...
<p align="center"><strong>107 production-grade security skills for cloud and AI — OCSF on the wire, MCP-ready, HITL-audited, sandboxed, runs everywhere the same bundle can.</strong></p>
...
**107 shipped skill bundles** — atomic, deterministic, single-concern. Twelve are guarded write paths; the other 95 are read-only. Drop one into a pipeline, an agent, a Step Function, or a `python ... | python ...` one-liner.
...
| **Detect** | 54 | deterministic rules tagged with MITRE ATT&CK / ATLAS / OWASP | OCSF Detection Finding 2004 |
...
**Total: 107 shipped skills.**  Live counts and per-framework coverage in [`docs/COVERAGE_SNAPSHOT.md`](docs/COVERAGE_SNAPSHOT.md) (auto-generated, CI-gated).
